...
public class PostTurn {
    public static void main(String[] args) {
        ...
        int cardTurnRank = Integer.parseInt(JOptionPane.showInputDialog("What's the rank of the turn card?"));
        String cardTurnSuit = JOptionPane.showInputDialog("What's the suit of the turn card?");
        ...
        Card turnCard = new Card(cardTurnRank, cardTurnSuit);
        ...
        for (int i = 0; i < 100000; i++) {
            River river = new River(firstFlopCard, secondFlopCard, thirdFlopCard, turnCard);


            CombinePostTurn com1 = new CombinePostTurn(cards1, river);
            CombinePostTurn com2 = new CombinePostTurn(cards2, river);
...
//                System.out.println(player1count);
    ...
    public static int compareHands(CombinePostTurn hand1, CombinePostTurn hand2) {
    ...
    public static boolean contains(River river, Card card) {
